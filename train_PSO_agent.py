...
def train():
    ...
    base_dir = f"./saved/off/gcn/{start_time}"

    # ✅ 新增：每 100 轮平均值记录列表 + Excel 路径
    avg_records_100 = []   # 每个元素: {"episode_end": ..., "avg_reward_100": ..., "avg_dvr_100": ...}
    ...
    for i in range(episodes):
        ...
        # ✅ 每 100 轮，计算最近 100 轮的平均值并写入 Excel
        ...
        if (i + 1) % 100 == 0 and len(reward_list) >= 100:
            ...
            # 覆盖写入 Excel：始终是“到目前为止每 100 轮的平均值”
